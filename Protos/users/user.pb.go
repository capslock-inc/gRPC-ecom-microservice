...
var file_Protos_users_user_proto_rawDesc = []byte{
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0x92, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65,
	...
	0x64, 0x65, 0x6c, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69,
...
var file_Protos_users_user_proto_depIdxs = []int32{
	...
	4, // 6: usermodel.UserService.GetAllUser:output_type -> usermodel.userlist
	3, // 7: usermodel.UserService.GetUserById:output_type -> usermodel.user
	1, // 8: usermodel.UserService.AddNewUser:output_type -> usermodel.status
	1, // 9: usermodel.UserService.UpdateUser:output_type -> usermodel.status
	1, // 10: usermodel.UserService.DeleteUser:output_type -> usermodel.status
